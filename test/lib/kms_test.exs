defmodule ExAws.KMSTest do
  ...
  test "CancelKeyDeletion" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "CancelKeyDeletion", "KeyId" => "key-id", "Version" => @version},
             headers: [
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.cancel_key_deletion("key-id")
  end
  ...
  test "CreateAlias" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.create_alias("alias-name", "key-id")
  end
  ...
  test "CreateGrant" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.create_grant("grantee-principal", "key-id")
  end

  test "CreateKey" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "CreateKey", "Version" => @version},
             headers: [
  ...
  test "DeleteAlias" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.delete_alias("alias-name")
  end
  ...
  test "DeleteImportedKeyMaterial" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.delete_imported_key_material("key-id")
  end

  test "DescribeKey" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "DescribeKey", "Version" => @version, "KeyId" => "key-id"},
             headers: [
    ...
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.describe_key("key-id", grant_tokens: ["list"])
  end

  test "DisableKey" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "DisableKey", "Version" => @version, "KeyId" => "key-id"},
             headers: [
    ...
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.disable_key("key-id", grant_tokens: ["list"])
  end

  test "DisableKeyRotation" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "DisableKeyRotation", "Version" => @version, "KeyId" => "key-id"},
             headers: [
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.disable_key_rotation("key-id")
  end

  test "EnableKey" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "EnableKey", "Version" => @version, "KeyId" => "key-id"},
             headers: [
  ...
  test "Encrypt" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.encrypt("key-id", "plaintext")
  ...
  test "GenerateDataKey" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "GenerateDataKey", "Version" => @version, "KeyId" => "key-id"},
             headers: [
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.generate_data_key("key-id")
  ...
  test "GenerateRandom" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "GenerateRandom", "Version" => @version, "NumberOfBytes" => 32},
             headers: [
  ...
  test "GetKeyPolicy" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.get_key_policy("key-id", "policy-name")
  end
  ...
  test "GetKeyRotationStatus" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.get_key_rotation_status("key-id")
  end
  ...
  test "ImportKeyMaterial" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.import_key_material("encrypted-key-material", "import-token", "key-id")
  end

  test "ListAliases" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "ListAliases", "Version" => @version},
             headers: [
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.list_aliases()
  end

  test "ListGrants" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "ListGrants", "Version" => @version, "KeyId" => "key-id"},
             headers: [
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.list_grants("key-id")
  end

  test "ListKeyPolicies" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "ListKeyPolicies", "Version" => @version, "KeyId" => "key-id"},
             headers: [
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.list_key_policies("key-id")
  end

  test "ListKeys" do
    assert %ExAws.Operation.JSON{
             before_request: nil,
             data: %{"Action" => "ListKeys", "Version" => @version},
             headers: [
  ...
  test "ListRetirableGrants" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.list_retirable_grants("retiring-principal")
  end
  ...
  test "PutKeyPolicy" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.put_key_policy("key-id", "policy", "policy-name")
  end
  ...
  test "ReEncrypt" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.re_encrypt("ciphertext", "key-id")
  end
  ...
  test "RetireGrant .retire_grant/1 use grant token" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.retire_grant(grant_token: "grant-token")
  end
  ...
  test "RetireGrant .retire_grant/1 use grant id and key id" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.retire_grant(grant_id: 123, key_id: "key-id")
  end
  ...
  test "RetireGrant .retire_grant/2" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.retire_grant("grant-token")
  end
  ...
  test "RetireGrant .retire_grant/3" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.retire_grant(123, "key-id")
  end
  ...
  test "ScheduleKeyDeletion" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.schedule_key_deletion("key-id")
  ...
  test "UpdateAlias" do
    assert %ExAws.Operation.JSON{
             ...
             service: :kms,
             stream_builder: nil
           } = ExAws.KMS.update_alias("alias_name", "target_key_id")
  end
